...
# Script para configurar Git Hooks no servidor Hostinger com subdomínios separados
# Versão modificada para funcionar a partir da pasta rei-do-oleo
# Execute este script no servidor Hostinger via SSH

set -e

echo "🚀 Configurando Git Hooks para subdomínios separados..."
...
../api-hom.virtualt.com.br/
../app-hom.virtualt.com.br/
EOF
